...
const hotels = [
  { name: "Kindia Palace Hotel", location: "Kindia" },
  { name: "Kankan Prestige Hotel", location: "Kankan" },
  { name: "Résidence Hôtelière Minière", location: "Kamsar" },
  { name: "Hotel Particulier HP", location: "Conakry" },
  { name: "Woro Ladia", location: "Conakry" },
  { name: "Grand Hôtel de l'Indépendance", location: "Conakry" }
];
