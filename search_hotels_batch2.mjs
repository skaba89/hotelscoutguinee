...
const hotels = [
  { name: "Hôtel M'Lys", location: "Conakry" },
  { name: "Hôtel Azur Conakry", location: "Conakry" },
  { name: "Setifana Sea View", location: "Conakry" },
  { name: "Hakaba", location: "Conakry" },
  { name: "Pension Les Palmiers", location: "Conakry" },
  { name: "Chez Sophie", location: "Conakry" }
];
